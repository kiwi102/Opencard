...
$_['entry_username']               = '用戶名:<span class="help">請輸入您的UPS Services account用戶名.</span>';
$_['entry_password']               = '密碼:<span class="help">請輸入您的UPS Services account密碼.</span>';
...
$_['entry_country']                = '始發國家:<span class="help">Enter the two-letter code for your origin country.</span>';
$_['entry_postcode']               = '始發地的郵遞區號:<span class="help">Enter your origin zip/postalcode.</span>';
